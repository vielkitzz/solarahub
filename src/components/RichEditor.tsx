...
const tiptapStyles = `
  ...
  [&_[style*='text-align:_center']]:text-center [&_[style*='text-align:_center']_img]:mx-auto
  [&_[style*='text-align:_right']]:text-right [&_[style*='text-align:_right']_img]:ml-auto
