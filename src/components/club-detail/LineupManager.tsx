          ...
          {bench.length === 0 ? (
            ...
            bench.map((p) => {
              ...
              return (
                ...
                >
                  <ShirtIcon   clubId={club?.id}   number={player.shirt_number}   highlighted={isSelected}   size="w-9 h-9"   isGK={player.position === "GOL"} />clubId={club?.id} number={p.shirt_number} size="w-9 h-9" />
                  <div className="flex-1 min-w-0">
